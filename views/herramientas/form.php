         ...
         <div class="modal-content">
             ...
             <form id="form_mantenimiento" class="row g-3 needs-validation" method="post">
                 <div class="modal-body">
                     <input hidden type="number" id="herramienta_id" name="herramienta_id" class="form-control" />
                     <div class="row">
                     ...
                     <div class="row">
                         <div class="col-lg-4  col-md-4">
                             <div class="mb-3">
                                 ...
                                 <div class="input-group has-validation">
                                     <input type="text" id="modelo" name="p_modelo" class="form-control"
                                         placeholder="Ingresar modelo" aria-describedby="modelo" required />
                         ...
                         <div class="col-lg-4   col-md-4">
                             <div class="mb-3">
                                 ...
                                 <div class="input-group has-validation">
                                     <input type="text" id="serie" name="p_serie" class="form-control"
                                         placeholder="Ingresar serie" aria-describedby="serie" required />
                         ...
                         <div class="col-lg-4   col-md-4">
                             <div class="mb-3">
                                 ...
                                 <div class="input-group has-validation">
                                     <input type="text" id="color" name="p_color" class="form-control"
                                         placeholder="Ingresar color" aria-describedby="color" required />
                     ...
                     <div class="row">
                         ...
                         <div class="col-lg-4 col-md-6">
                             <div class="mb-3">
                                 <label for="estado_herramienta" class="form-label">Estado del Equipo</label>
                                 <div class="input-group has-validation">
                                     <select class="form-control" name="p_estado_herramienta" id="estado_herramienta"
                                         aria-describedby="p_estado_herramienta" required>
                                         <option value="">Seleccionar</option>
                                         <option value="Nuevo">Nuevo</option>
                                         <option value="Regular">Regular</option>
                                         <option value="Viejo">Viejo</option>
                                     </select>
                                     <div id="estado_herramienta_error" class="invalid-feedback">
