...
<head>
    <title>Herramientas  | InvenTechPE</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-1">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Herramientas & Muebles </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Lista de Herramientas </h5>
                                </div>
                                        ...
                                        <table id="table_herramientas"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Modelo: activate to sort column ascending">Modelo
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Serie: activate to sort column ascending">Serie</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
