...
function save_user_and_update(e) {
 ...
 /* if (!form_validations()) {
  ...
  $.ajax({
    url: "../../controllers/UnidadController.php?endpoint=save_and_update_unidades",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false,
    success: function (data) {
      ...
      $("#table_unidad").DataTable().ajax.reload(); 
      swal.fire({
...
$(document).ready(function () {  
  ...
  $("#table_unidad").DataTable({
    ...
    ajax: {
      url: "../../controllers/UnidadController.php?endpoint=list_unidades",
      type: "post",
      data: { true: true },
    },
    bDestroy: true,
...
function editar(Id) {
  $.post(
    "../../controllers/UnidadController.php?endpoint=list_unidad_id",
    { unidad_id: Id },
    function (data) {
      //console.log(data);
  ...
  $("#label_title").html("Actualizar Unidad de medida");
  ...
  swal
    ...
    .then((result) => {
      if (result.value) {
        ...
        $.post(
          "../../controllers/UnidadController.php?endpoint=delete",
          { unidad_id: Id },
          function (data) {
...
$(document).on("click", "#btn_nuevo_registro", function () {
  ...
  $("#label_title").html("Registrar Nueva Unidad de medida");
