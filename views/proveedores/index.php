...
<head>
    <title>Proveedores | InvenTechPE</title>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="sorting sorting_asc" tabindex="0"
                                                        ...
                                                        aria-sort="ascending"
                                                        aria-label="Tipo Documento: activate to sort column descending"
                                                        style="width: 124.4px;">Tipo Documento</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="N° Doc: activate to sort column ascending"
                                                        style="width: 195.4px;">N° Doc</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Nombres: activate to sort column ascending"
                                                        style="width: 195.4px;">Nombres</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Apellidos: activate to sort column ascending"
                                                        style="width: 195.4px;">Apellidos</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Teléfono: activate to sort column ascending"
                                                        style="width: 195.4px;">Teléfono</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Dirección: activate to sort column ascending"
                                                        style="width: 195.4px;">Dirección</th>
                                                    <th class="sorting" tabindex="0" aria-controls "buttons-datatables"
                                                        rowspan="1" colspan="1" aria-label="Notas: activate to sort column ascending"
                                                        style="width: 195.4px;">Categoría</th>
                                                        <th class="sorting" tabindex="0" aria-controls "buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Notas: activate to sort column ascending"
                                                        style="width: 195.4px;">Notas</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
