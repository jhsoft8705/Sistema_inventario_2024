    ...
    <div class="layout-width">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                        ...
                        <div class="tab-content" id="notificationItemsTabContent">
                            <!---<div class="tab-pane fade p-4" id="all-noti-tab" role="tabpanel" aria-labelledby="alerts-tab">
                ...
                <input hidden  name ="usuario_id_session"id="usuario_id_session"type="text" value="<?php echo $_SESSION["usuario_id"]?>">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text"><?php echo $_SESSION["nombre_rol"]?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
