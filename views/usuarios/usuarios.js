...
$(document).ready(function () { 
  /*TODO:listar roles*/
  $.post("../../controllers/RolController.php?enpoint=get_role_jcombox", { true: true }, function (data) {
      console.log("Datos recibidos para roles:", data);
      $("#rol_id").html(data);
     }); 
...
function editar(Id) {
  $.post(
    ...
    function (data) {
      ...
      if (data.notificacion === "SI") {
        $("#notificacion").prop("checked", true);
      } else {
        $("#notificacion").prop("checked", false);
      }*/
    }
  );
  $("#label_title").html("Actualizar Usuario");
...
$(document).on("click", "#btn_nuevo_registro", function () {
  ...
  $("#label_title").html("Registrar Nuevo Usuario");
