...
<head>
    <title>Usuarios | InvenTechPE</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Listar de usuarios</h5>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="buttons_table" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                        <table id="table_users" class="display table table-bordered dataTable no-footer"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        ...
                                                        style="width: 88.4px;">Corre electrónico</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Age: activate to sort column ascending"
                                                        style="width: 37.4px;">Contraseña</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Start date: activate to sort column ascending"
                                                        style="width: 82.4px;">Rol</th>
                                                    <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                                        rowspan="1" colspan="1"
