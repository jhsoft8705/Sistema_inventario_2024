...
<head>
    <title>Ubicaciones | InvenTechPE</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Lista de Ubicaciones</h5>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="buttons_table" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                        <table id="table_ubicacion" class="display table table-bordered dataTable no-footer"
