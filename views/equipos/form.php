         ...
         <div class="modal-content">
             ...
             <form id="form_mantenimiento" class="row g-3 needs-validation" method="post">
                 <div class="modal-body">
                     <input hidden type="number" id="equipo_id" name="equipo_id" class="form-control" />
                     <div class="row">
                     ...
                     <div class="row">
                         ...
                         <div class="col-lg-4 col-md-6">
                             <div class="mb-3">
                                 ...
                                 <div class="input-group has-validation">
                                     <select class="form-control" name="p_estado_equipo" id="estado_equipo"
                                         aria-describedby="estado_equipo" required>
                                         <option value="">Seleccionar</option>
